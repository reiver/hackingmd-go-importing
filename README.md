# HACKING.md for Importing in Golang
...
This [HACKING.md](HACKING.md) file is the _default_ `HACKING.md` file that I use for **importing** in the **Go programming-language** (**golang**).
...
git submodule add https://github.com/reiver/hackingmd-go-importing
```
